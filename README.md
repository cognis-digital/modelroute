...
[![PyPI](https://img.shields.io/pypi/v/cognis-modelroute.svg)](https://pypi.org/project/cognis-modelroute/)
[![CI](https://github.com/cognis-digital/modelroute/actions/workflows/ci.yml/badge.svg)](https://github.com/cognis-digital/modelroute/actions)
...
MODELROUTE exists for one job — local model router / proxy across ollama, vllm, and cloud with fallback — and does it without a SaaS bill or heavyweight setup.
...
```bash
modelroute --version
modelroute scan .                      # scan the current project
modelroute scan . --format json
modelroute scan . --fail-on high       # non-zero exit for CI gates
modelroute mcp                         # expose as an MCP server (Cognis.Studio / Claude Desktop / Cursor)
```
...
Built in the spirit of **LiteLLM**, re-framed for the Cognis approach: single-purpose, self-hostable,
MCP-native, and unified with the rest of the Suite. Missing a credit? Open a PR.

## How it fits the Cognis Neural Suite

`modelroute` is one of the **100+ tools** in the [Cognis Neural Suite](https://github.com/cognis-digital).
