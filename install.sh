#!/usr/bin/env sh
# Universal installer for modelroute. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/modelroute.git"
echo "Installing modelroute ..."
